...
public class ClassificationResponseParserTests
{
    private const string ValidJson = """
        { "category": "DotNet", "action": "ATester", "priority": "Haute", "reason": "Nouvel outil .NET intéressant." }
        """;
    ...
    public void Parse_ValidJson_ReturnsExpectedResult()
    {
        ...
        Assert.Equal(Category.DotNet, result.Category);
    ...
    {
        const string json = """{ "category": "dotnet", "action": "atester", "priority": "haute", "reason": "ok" }""";
    ...
    {
        const string json = """{ "category": "PasUneCategorie", "action": "ATester", "priority": "Haute", "reason": "x" }""";
    ...
    {
        const string json = """{ "category": "DotNet", "action": "ATester", "reason": "x" }""";
