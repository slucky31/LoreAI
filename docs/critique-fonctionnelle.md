...
|---|---|---|---|---|
| **O7** | **Sauvegarde réelle** — pgBackRest (repo1 sur disque USB, miroir Google Drive) **déployé et restauration testée sur `mcm8` le 2026-09-13**, `.env` chiffré hors du Pi toujours à faire | 3 | 1 | F9. Le seul risque non rattrapable du projet |
